    ...
    def __init__(
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["Blender"](
                args.source_path, args.white_background, args.eval, args.num_pts
            )
            ...
            print("Found train folder, assuming Fox (InstantNGP style) data set!")
            scene_info = sceneLoadTypeCallbacks["Fox"](
                args.source_path, args.eval, args.num_pts, llffhold=8
            )
            self.scene_type = "InstantNGP"

        elif os.path.exists(os.path.join(args.source_path, "sensor_data")):
            print("Found sensor_data folder, assuming ScannetV2 data set!")
            scene_info = sceneLoadTypeCallbacks["ScannetV2"](
                args.source_path,
                args.eval,
                llffhold=8,
            )

            self.scene_type = "ScannetV2"
        ...
        self.cameras_translation = scene_info.nerf_normalization["translate"]
